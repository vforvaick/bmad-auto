...
description: Run the BMAD story pipeline in an isolated git worktree, merging only after the configured BMAD steps pass. Use when the user wants safer per-story isolation.
---
