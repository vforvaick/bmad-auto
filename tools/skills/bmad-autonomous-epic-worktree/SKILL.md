---
name: bmad-autonomous-epic-worktree
description: Deliver all incomplete stories in one BMAD epic through continuous autonomous worktree execution. Use when the user wants one epic completed end-to-end with internal story gates, sequential merges, and non-blocking multi-agent sidecars.
---
